...
public interface SigPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the containment reference list '{@link sig.Ville#getPersonnes <em>Personnes</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Personnes</em>'.
	 * @see sig.Ville#getPersonnes()
	 * @see #getVille()
	 * @generated
	 */
	EReference getVille_Personnes();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference VILLE__PERSONNES = eINSTANCE.getVille_Personnes();
